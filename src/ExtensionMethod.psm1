...
function New-ExtendedTypeData {
 ...
 param(
  ...
  End {
    ...
    #todo Test
    # it will execute the else-clause even if the function is called without getting input from either the pipeline or a parameter.
    # So additional code logic is advisable ...
