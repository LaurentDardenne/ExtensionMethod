#
# Module manifest for module 'ExtensionMethod'
#
# Generated by: LaurentDardenne
#
# Generated on: 11/02/2017
#
...
GUID = 'd3a2a98a-1103-457a-88dd-5065048abb29'
...
Description = 'Creation of ps1xml file dedicated to the extension methods contained in an assembly. '
...
RequiredModules=@(
    ...
    @{ModuleName="UncommonSense.PowerShell.TypeData";GUID="eb90261b-fbaa-4b20-85ae-2fc44dc0b7de"; ModuleVersion="1.1.0"}
)
#<UNDEF %DEBUG%>
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ProjectUri = 'https://github.com/LaurentDardenne/ExtensionMethod'
